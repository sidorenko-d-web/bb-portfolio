...
export const data = [
	{
		...
		desc: 'Данный проект решает важную проблему, при занятиях спидкубингом* - сохранение каждого результата на сервере. Ни один из популярных, в наши дни, таймеров, не позволяет бесшовно сохранить всё и иметь доступ к результатам с любой платформы. <br/> <br/>  В будущем планируется мобильная адаптация, React Native  приложение, соц составляющая: чаты, соревнования, лидерборды. <br/> <br/>   Спидкубинг* - сборка кубика Рубика на скорость',
		front: [
			'TypeScript',
			'Next.JS',
			'ReactHookForm',
